...
class AttendanceDaysStudent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title:Text('Absence Days',
      style: TextStyle(
      ...
      body: ListView.separated(
        itemBuilder: (context, index) {
          return Padding(
              padding: const EdgeInsets.only(left: 50, right: 500, top: 30,bottom: 60),
              child: Container(
                width: 50,
                height: 140,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          IconButton(onPressed:(){}, icon:Icon(Icons.delete,size: 40,color: AppColors.darkBlue,)),
                        ],
                      )
                    ],
                  ),
